...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/df8674b001c3c2b12a6645dd547b9b6441ad900b/mongodb/mongodb.d.ts
declare module "mongodb" {
  ...
  export class MongoClient {
    ...
    static connect(uri: string, options?: MongoClientOptions): any;
    ...
    connect(uri: string, options?: MongoClientOptions): any;
  ...
  export class Db extends EventEmitter {
    ...
    executeDbAdminCommand(command: Object, options?: { readPreference?: ReadPreference | string, maxTimeMS?: number }): any;
    ...
    indexInformation(name: string, options?: { full?: boolean, readPreference?: ReadPreference | string }): any;
    ...
    logout(options?: { dbName?: string }): any;
    ...
    removeUser(username: string, options?: { w?: number | string, wtimeout?: number, j?: boolean }): any;
    ...
    stats(options?: { scale?: number }): any;
  ...
  export interface Admin {
    ...
    addUser(username: string, password: string, callback: MongoCallback<any>): void;
    addUser(username: string, password: string, options?: AddUserOptions): any;
    ...
    command(command: Object, callback: MongoCallback<any>): void;
    command(command: Object, options?: { readPreference?: ReadPreference | string, maxTimeMS?: number }): any;
    ...
    removeUser(username: string, callback: MongoCallback<any>): void;
    removeUser(username: string, options?: FSyncOptions): any;
