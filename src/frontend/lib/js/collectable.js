var collectable = function(img, gravity, position, width, height, bounds, options){
    this.img = null;
    this.name = '';
    ...
    this.sprite = null;
    this.offset = {x:0,y:0};
    this.effects = {destroyAfter:null, callback:null};
    this.create = function(img, gravity, position, width, height, options){
            ...
            if ( typeof(options) != "undefined" ){
                    ...
                    if(typeof(options.sprite) != "undefined"){
                        ...
                        var runOnce = (typeof(options.sprite.runOnce) !== "undefined") ? options.sprite.runOnce  : false;
                        if(typeof(this.sprite.static) != "undefined" && this.sprite.static){
                            ...
                            with(this.sprite.right){
                                 spritesheet = new SpriteSheet(img, spritesheet[0], spritesheet[1]);
                                 idle = new Animation(spritesheet, idle[0], idle[1], idle[2],runOnce); 
                                 destroy = new Animation(spritesheet, destroy[0], destroy[1], destroy[2]);
                            }  
                        }
                    }
    ...
    this.doEffects = function(){
        if(typeof(this.self.effects.callback) != "undefined" && typeof(this.self.effects.callback) == "function"){
            this.self.effects.callback();
        }
        if(this.self.effects.destroyAfter) {
            game.removeCollectable(this.self.id);
        }
    }
